...
const outputFilePath = path.join(__dirname, '../src/data/salons.json');
...
const includeKeywords = ['미용', '미용실', '뷰티'];
...
fs.createReadStream(inputFilePath)
  ...
  .on('end', () => {
    ...
    console.log(`Successfully converted ${results.length} beauty salon facilities to JSON.`);
