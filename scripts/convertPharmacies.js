...
const inputFilePath = path.join(__dirname, '../public/data/pharmacies.csv');
const outputFilePath = path.join(__dirname, '../src/data/pharmacies.json');
...
fs.createReadStream(inputFilePath)
  ...
  .on('end', () => {
    ...
    console.log(`Successfully converted ${results.length} active animal pharmacies to JSON.`);
