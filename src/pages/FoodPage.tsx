...
import { foodShops } from '../data/partyShops';
...
export const FoodPage: React.FC<FoodPageProps> = ({ onBack, onNavigate }) => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-white selection:text-black">
      ...
      <section className="pt-40 pb-20 px-6 max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        >
          건강하고 맛있는 반려동물 먹거리 브랜드들을 엄선했습니다. 아이들의 입맛을 사로잡을 특별한 간식을 준비해 보세요.
        </motion.p>
      </section>
