...
export const SITE_CONFIG = {
  ...
  // 시네마틱 텍스트 섹션
  cinematic: {
    text: '우리아가(U-AGA)의 세계에 오신 것을 환영합니다. 이곳은 숨겨진 보석 같은 아이템을 소개하는 갤러리이자, 우리 아이의 가장 예쁜 순간을 전 세계와 나누는 글로벌 무대입니다. 매일 입는 옷과 먹거리부터, 건강을 책임질 병원 정보, 동반 가능한 핫플 안내까지. 반려동물과 함께하는 당신의 모든 시간에 가장 완벽하고 든든한 길잡이가 되겠습니다. 우리의 큐레이션으로 오늘 하루를, 그리고 평생의 추억을 선물하세요.',
  },
